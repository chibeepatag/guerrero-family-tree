...
export default class extends Controller {
  ...
  createTemplates(){
    ...
    FamilyTree.templates.yellow_male.node = '<line x1="13" x2="13" y1="0" y2="90" stroke="#FFB604" stroke-width="25" opacity="0.35"/><rect x="25" y="0" height="90" width="350" stroke-width="0" fill="#F1F1F1" ></rect>';
    FamilyTree.templates.yellow_female = Object.assign({}, FamilyTree.templates.yellow);
    FamilyTree.templates.yellow_female.node = '<line x1="13" x2="13" y1="0" y2="90" stroke="#FFB604" stroke-width="25"/><rect x="25" y="0" height="90" width="350" stroke-width="0" fill="#F1F1F1"></rect>';
